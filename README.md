...
- Block
	...
	This folder contains the files used and generated in the block attack,
	1 test case file.
- Eaves

	This folder contains the files used and generated in the eavesdropping
	attack, 18 test case files.
- Edit

	This folder contains the files used and generated in the edit attack
...
- Freeze
	...
	This folder contains the files used and generated in the freeze
	attack, 0 test case file.
- Spoof

	This folder contains the files used and generated in the spoof attack,
	2 test case files.
...
- Root_Full_Verification.cspm
	...
	This file is used by the primary ECU to verify the root metadata.

- Snapshot_Full_Verification.cspm

	This file is used by the primary ECU to verify the snapshot
	metadata.

- Targets_Full_Verification.cspm

	This file is used by the primary ECU to verify the targets
	metadata.

- Targets_P_Verification.cspm

	This file is used by the secondary ECU to do a partial verification
	on the targets metadata.
	
- Timestamp_Full_verification.cspm

	This file is used by the primary ECU to verify the timestamp
	metadata.
...
- Server.cspm
	...
	The file server has all of the metadata that is held within the
...
- Vehicle.cspm
	...
	The vehicle file defines the metadata that is used, it also contains
...
- Attacker.cspm
	...
	This file contains all of the attackers and their integration into
	the overall Uptane model, as well as the assertions.

- UptaneFullModel.cspm

	This file contains the integrated attacks into the model.
